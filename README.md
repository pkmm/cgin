...
#### build status
[![Build and Deploy](https://github.com/pkmm/cgin/actions/workflows/go.yml/badge.svg?event=push)](https://github.com/pkmm/cgin/actions/workflows/build_deploy.yml)